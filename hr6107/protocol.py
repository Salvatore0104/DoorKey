...
class ProtocolProfile:
    ...
    def audio_tx_config(self) -> dict[str, Any]:
        ...
        return {
            ...
            "initial_sequence": int(audio.get("initial_sequence", 0)),
            "time_seconds_offset": audio.get("time_seconds_offset"),
            "time_microseconds_offset": audio.get("time_microseconds_offset"),
